<template>
  <div class="auditionBox padTop20">
    <el-form ref="form" :model="form" label-width="205px" :rules="rules">
      <el-row>
        <el-col :span="8" >
          <el-form-item label="预约二次试听时间：" prop="appointmentDatetime">
            <el-date-picker
        ...
        <el-col :span="8" >
          <el-form-item label="方案订制状态：" prop="schemeMakeState"><!--schemeMakeStates-->
        ...
        <el-col :span="8">
          <el-form-item label="是否完成二次试听：" prop="hasComplete">
        ...
        <el-col :span="8">
          <el-form-item label="二次试听干预导师：" prop="serviceTutorial">
        ...
        <el-col :span="24">
          ...
          <el-row>
            <el-col style="width: 350px; margin-right: 10px;">
              <el-form-item label="二次试听反馈：" prop="auditionFeedbackState">
        ...
        <el-col :span="24">
          <el-form-item label="二次试听科目及内容：" prop="auditionSubjectCode"><!--auditionSubjectCode-->
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="报名学科">
                <el-checkbox-group
                  v-model="signUpSubjectCodes">
                  <el-checkbox
                    v-for="item in subjectList"
                    :label="item.subjectCode"
                    :key="item.subjectCode">{{item.subjectName}}</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
            </el-col>
            <el-col :span="24">
    ...
    data() {
      return {
        ...
        rules: {
          ...
          serviceTutorial: [
            {required: true, message: "请选择二次试听干预导师"},
          ],
          hasComplete: [
            {required: true, message: "请选择是否完成二次试听"},
          ],
          intentionLevel: [
            {required: true, message: "请选择用户意向等级"},
          ],
          auditionFeedbackState:[
            {required: true, message: "请选择二次试听反馈"},
          ],
          auditionSubjectCode:[
            {required: true, message: "二次试听科目"},
          ],
          auditionContent:[
            {required: true, message: "二次试听内容"},
          ],
                ...
                .then(res => {
                  if(res.code=="000000"){
                    this.$message({
                     ...
                     this.$router.push({path:"/editAuditionT"})
                  }else{
                    this.$message({
                      type: 'warning',
                      message: res.message
