  ...
  <div class="editAuditionBox padTop20">
    <div class="stu-body">
      <el-row v-if="tmpUserInfo">
        <el-col :span="8">
          <el-row>
            <el-col :span="9">预约二次试听时间：</el-col>
            <el-col :span="15">{{auditionRecordObj.appointmentDatetime | convertDate}}</el-col>
          </el-row>
        </el-col>
        <el-col :span="8">
          <el-row>
            <el-col :span="9">方案定制状态：</el-col>
            <el-col :span="15" v-if="auditionRecordObj.schemeMakeState=='1'">已完成</el-col>
            <el-col :span="15" v-if="auditionRecordObj.schemeMakeState=='0'">未完成</el-col>
          </el-row>
        </el-col>
        <el-col :span="8">
          <el-row>
            <el-col :span="9">分配方案制定导师：</el-col>
            <el-col :span="15">{{auditionRecordObj.schemeTutorialName}}</el-col>
          </el-row>
        </el-col>
        <el-col :span="8">
          <el-row>
            <el-col :span="9">是否完成二次试听：</el-col>
            <el-col :span="15">{{auditionRecordObj.hasComplete=="0"?"否":"是"}}</el-col>
          </el-row>
        </el-col>
        <el-col :span="8">
          <el-row>
            <el-col :span="9">二次试听干预导师：</el-col>
        ...
        <el-col :span="24">
          <el-row>
            <el-col :span="3">二次试听科目及内容：</el-col>
            <el-col :span="21">
        ...
        <el-col :span="8">
          <el-row>
            <el-col :span="9">切单情况：</el-col>
          <el-col :span="15">{{commeCut[auditionRecordObj.cutListState]}} <span v-if="auditionRecordObj.cutListState>1">原因：{{auditionRecordObj.cutListReason}}</span></el-col>
          </el-row>
        </el-col>
        <el-col :span="24">
          <el-row>
  ...
  export default {
    ...
    methods: {
          ...
          .then(res => {
            if(res.code=="000000"){
              ...
              if(result.length>0){
                ...
                $this.$router.push({path:'/editAuditionT/add'})
              }
      ...
      go(){
        ...
        this.$router.push({path:'/editAuditionT/add',query:{edit:1}})
      },
